...
import com.example.demo.config.MyAvertissementConstants;



@RestController
public class AvertissementEmailRestController {
	...
	@ResponseBody
    @RequestMapping("/api/sendSimpleEmail")
    public String sendSimpleEmail() {

        // Create a Simple MailMessage.
        SimpleMailMessage message = new SimpleMailMessage();
        
        message.setTo(MyAvertissementConstants.FRIEND_EMAIL);
    ...
    public String sendAttachmentEmail() throws MessagingException {
        ...
        helper.setTo(MyAvertissementConstants.FRIEND_EMAIL);
